...
//
// All environment variables are prefixed with "BASECOAT". Ex: BASECOAT_DEBUG=true
//
// Most envvar configuration abides by common envvar string=string formatting: Ex. `export BASECOAT_DEBUG=true`.
// Complex envvars might take a json string as value.
//
//	Example: export BASECOAT_EXTENSIONS="{"name":"test"},{"name":"test2"}"
package config
