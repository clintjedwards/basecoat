// Package models contains the core objects(otherwise called the domain models) needed by Basecoat internally.
//
// This package exists to provide easy to use in-memory objects for concepts Basecoat has to work with.
